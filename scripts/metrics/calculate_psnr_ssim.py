...
def main(args):
    ...
    # img_path = sorted(glob.glob(self.lq_folder))
    # gt_path = [item.replace("low_blur", "high_sharp") for item in img_path]
    # /amax/tuluwei/dataset/lol_blur_test1/test/low_blur
    # /amax/tuluwei/dataset/lolblur/test
    img_list_gt=sorted(glob.glob("/amax/tuluwei/dataset/lolblur/test/high_sharp/*/*"))
    img_list_restored=[item.replace("high_sharp", "low_blur").replace("lolblur","lol_blur_test_4000") for item in img_list_gt]
