...
load_path="/data/tuluwei/code/FDN/checkpoint/FDN_lolblur.pth"

load_path_pred="/data/tuluwei/code/FDN/checkpoint/LPNet_lolblur.pth"
...
with torch.no_grad():
    ...
    for img1,gt in zip(imgs,imgs_gt):
        ...
        imwrite(result,img1.replace("lolblur","FDN_lolblur"))
        # break